...
enum class COSEAlgorithmIdentifier(val value: Long) {
    ...
    ES256K(-47), // ECDSA using secp256k1 curve and SHA-256 (RFC 8812); -43 is SHA-384
    ;
...
fun COSEAlgorithmIdentifier.getAlgorithmParameterSpec(): AlgorithmParameterSpec? = when (this) {
    ...
    // ES512 is defined over P-521; "secp521r1" is the JCA name for it. There is no secp512r1.
