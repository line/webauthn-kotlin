...
internal class BiometricAuthenticator(
    ...
    override var fido2PromptInfo: Fido2PromptInfo? = null,
    ...
    override val authenticationHandler: AuthenticationHandler =
        BiometricAuthenticationHandler(activity, authenticationDispatcher)
) : Authenticator(
    activity,
    db,
    fido2PromptInfo,
    ...
    override val authType: AuthenticatorType = AuthenticatorType.Biometric
